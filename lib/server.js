...
router = {
    ...
    'api/post' : handlers.post,
    'api/tokens' : handlers.tokens,
    'api/post/comments' : handlers.comments,
    'api/post/allcomments' : handlers.Allcomments,
    'api/categories' : handlers.categories,
    'api/post/allcategory' : handlers.allCategories,
    // html servers
    'api/post/edit' : handlers.editPostHtml,
    'post': handlers.individualPosthtml,
    'posts' : handlers.postHtml,
    'login' : handlers.loginHtml,
    'post/create' : handlers.CreatePostHtml,
    'post/categories': handlers.categoryHtml,
    'api/categories/edit': handlers.categoryEdithtml,
    'post/comments' : handlers.commentHtml
};
